  ...
  List<Event> events = [
    Event(
      ...
      organizer: User(
        ...
        lastName: 'Done',
        age: 30, // Default age
        userBadges: [EventBadge(name: 'Yoga Enthusiast')], // Default badge
      ),
      registeredUsers: [],
    ...
    Event(
      ...
      organizer: User(
        ...
        lastName: 'Brown',
        age: 25, // Default age
        userBadges: [EventBadge(name: 'Cooking Pro')], // Default badge
      ),
      registeredUsers: [],
    ...
    Event(
      ...
      organizer: User(
        ...
        lastName: 'Davis',
        age: 28, // Default age
        userBadges: [EventBadge(name: 'Movie Buff')], // Default badge
      ),
      registeredUsers: [],
    ...
    Event(
      ...
      organizer: User(
        ...
        lastName: 'Wilson',
        age: 35, // Default age
        userBadges: [EventBadge(name: 'Creative Soul')], // Default badge
      ),
      registeredUsers: [],
    ...
    Event(
      ...
      organizer: User(
        ...
        lastName: 'Martinez',
        age: 22, // Default age
        userBadges: [EventBadge(name: 'Fitness Fanatic')], // Default badge
      ),
      registeredUsers: [],
