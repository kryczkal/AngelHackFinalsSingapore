...
class AppManagerSingleton {
  ...
  static final ReportCardFixedData _reportCardFixedDataWeek = 
      ReportCardFixedData(
          categoryRatingTable: [
        (4.5, EventCategory.food),  // Dining experiences in restaurants, special meals
        (3.2, EventCategory.sports),  // Gym, pool, tennis, yoga classes
        (4.3, EventCategory.artificialIntelligence),  // AI workshops or tech talks
        ...
        (2.8, EventCategory.travel),  // Travel packages, guided tours, hotel excursions
...
static final ReportCardFixedData _reportCardFixedDataMon =
      ReportCardFixedData(
        ...
        (3.2, EventCategory.beauty),  // Beauty treatments like facials, manicures
...
static final ReportCardFixedData _reportCardFixedDataHalfYear =
      ReportCardFixedData(
          categoryRatingTable: [
        (4.9, EventCategory.artificialIntelligence),  // Major tech event, AI conference
        ...
        (4.5, EventCategory.travel),  // Hotel excursions or organized travel activities
        (3.8, EventCategory.education),  // Educational events or workshops hosted by the hotel
        (3.1, EventCategory.environment),  // Eco-friendly or green hotel activities
      ],
